...
## Introduction
This is a mod being developed by @defeatedcrow. <br> 現在の開発環境はMC1.12.2です。
...
HeatAndClimateから、いくつかのBlockとEntityを抜き出した単発Modです。<br>It is a one-shot mod that selected some Block and Entity from HeatAndClimate.<br>
