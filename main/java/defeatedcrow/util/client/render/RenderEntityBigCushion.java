...
import defeatedcrow.util.client.model.ModelCushion;
...
public class RenderEntityBigCushion extends Render<EntityBigCushion> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_util", "textures/entities/cushion_gray.png");
