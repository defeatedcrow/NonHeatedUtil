...
import defeatedcrow.util.client.model.ModelFlowerPot;
...
public class RenderEntityFlowerPot extends Render<EntityFlowerPot> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_util",
			"textures/entities/flower_pot_brown.png");
	...
	private void renderCrossBlock(Block block, int meta, double x, double y, double z, float yaw, float partialTicks) {
		...
		float f1 = 1.0F;
		float f2 = 1.0F;
		MapColor mapcolor = state.getMapColor(FMLClientHandler.instance().getWorldClient(), new BlockPos(x, y, z));
		if (mapcolor != null) {
