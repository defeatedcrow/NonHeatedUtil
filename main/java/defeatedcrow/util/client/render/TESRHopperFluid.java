...
import defeatedcrow.util.client.model.ModelHopperF;
...
public class TESRHopperFluid extends TileEntitySpecialRenderer<DCLockableTE> {

	private static final String TEX = "dcs_util:textures/tiles/hopper_fluid.png";
